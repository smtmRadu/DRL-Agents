...
{
    // v5.10
    // introducing RaySensor

    // v5.9
    // hyperparameters are now in a separate script
    ...
    public class AgentBase : UnityEngine.MonoBehaviour
    {
        ...
        [Space(5), SerializeField, ReadOnly, Tooltip("@ shows the error of a mini-batch")] private float error;




        [HideInInspector] public HyperParameters hyperParameters;
        //ONLY HEURISTIC 
        ...
        protected virtual void Awake()
        {
            ...
            //Precaution
            if (hyperParameters.activationType == ActivationFunctionType.SoftMax)
            {
                ...
                hyperParameters.activationType = ActivationFunctionType.Tanh;
            }
        ...
        void SelfAction()
        {
            if (network == null)
            {
                ...
                NeuralNetwork.activation = hyperParameters.activationType;
                NeuralNetwork.outputActivation = hyperParameters.outputActivationType;
                NeuralNetwork.initialization = hyperParameters.initializationType;
        ...
        void HeuristicPreparation()
        {
            ...
            if (module == HeuristicModule.Learn)
            {
                ...
                miniBatchesNumber = (int)(1f / hyperParameters.batchSplit);
        ...
        void ProcessOneBatch()
        {
            if (epochs > 0)
            {
                ...
                {
                    network.UpdateGradients(sample.inputs, sample.expectedOutputs, hyperParameters.lossFunction);
                });

                //Apply gradients
                network.ApplyGradients(hyperParameters.learnRate, batches[currentMiniBatchIndex].Count, hyperParameters.momentum, hyperParameters.regularization);
    ...
    public class TrainerBase : UnityEngine.MonoBehaviour
    {
        ...
        void SetupTeam()
        {
            ...
            NeuralNetwork.activation = team[0].script.hyperParameters.activationType;
            NeuralNetwork.outputActivation = team[0].script.hyperParameters.outputActivationType;
            NeuralNetwork.initialization = team[0].script.hyperParameters.initializationType;
