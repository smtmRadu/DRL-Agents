...
public class AgentBase : MonoBehaviour
{
    ...
    [SerializeField, Range(1, 100), Tooltip("The number of Hidden Layers")] private int deep = 3;
    ...
    [Space(40)]
    [Tooltip("[InspectorUse ONLY]\nif false -> network var is null (if it has a saveFile, the network must be loaded using SetNetworkFromFileFunction(this.path,this.network")]
    public bool networkStatus = false;
    public float currentNNFitness = 0f;
    [Space]
    [Tooltip("[BUTTON]\nInstatiate NeuralNetwork + create a save file + path")] 
    public bool CreateBrain = false;
    [Tooltip("[BUTTON]\nResets the current NeuralNetwork data")]
    ...
    /// <summary>
    /// 
    /// Sets the Network for this AgentBase from another file. The Method Updates his current File with the new Network including Fitness
    /// </summary>
    ...
    {
        //This Function Assigns a TXT file to this AgentBase, he can modify it
        this.path = path;
        this.network = null;
        SetNetworkFromFile(path, ref this.network);
    }
    ...
    public void AssignCopyOfNeuralNetworkFrom(string path)
    {
        ...
        //This Function Make a copy of the TXT file and assigns it to this AgentBase, he can modify the copy not the original
    ...
    private void Default()
    {
        if (network == null)
        {
            ...
            {
                //Because HeuristicTesting() was not implemented the Object will be Static
            }
    ...
    protected virtual void HeuristicTesting()
    {
    ...
    protected virtual bool OnOutputsReceived(in float[] ActionBuffer) // Inference ONLY
    {
