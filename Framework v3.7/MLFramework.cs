...
namespace MLFramework
{
    ...
    public class TrainerBase : UnityEngine.MonoBehaviour
    {
        ...
        public bool cameraFollowBestAI = true; GameObject cam;
        ...
        private void EnvironmentSetup()
        {
            ...
            catch { Debug.LogError("Environment tag doesn't exist and no Environments too. Please create a tag called Environment and assign to a Environment"); }
            ...
            if (environmentsNumber == 1)
            {
                ...
                Transform Start = Environments[0].transform.Find("Start");
                ...
                for (int i = 0; i < environmentsNumber; i++)
                {
                    ...
                    Transform StartGameObject = Environments[i].transform.Find("Start").transform;
                    GetAllTransforms(StartGameObject, ref Start);
