...
namespace MLFramework
{
    ...
    public class AgentBase : UnityEngine.MonoBehaviour
    {
        ...
        [Tooltip("@path of the training data file\n@appending is writing is applied here\n@learning data is taken from here")] public string samplesPath = null;
    ...
    public class TrainerBase : UnityEngine.MonoBehaviour
    {
        ...
        protected List<PosAndRot>[] environmentsInitialTransform;//Every list is all transforms of a single interactionType
