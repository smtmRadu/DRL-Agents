...
namespace MLFramework
{
    ...
    {
        public static MutationStrategy mutationType = MutationStrategy.Classic;
        ...
        {
            if (mutationType == MutationStrategy.Classic)
                ClassicMutation(ref weight);

            else if (mutationType == MutationStrategy.LightPercentage)
                LightPercentageMutation(ref weight);
            else if (mutationType == MutationStrategy.LightValue)
                LightValueMutation(ref weight);

            else if (mutationType == MutationStrategy.StrongPercentage)
                StrongPercentagegMutation(ref weight);
            else if (mutationType == MutationStrategy.StrongValue)
                StrongValueMutation(ref weight);

            else if (mutationType == MutationStrategy.Chaotic)
                ChaoticMutation(ref weight);
        }
        ...
        void ChaoticMutation(ref float weight)
        {
            ...
            if (chance < .125f)
                weight = GetNumberFromStandardNormal();
            else if (chance < .3f)
                ClassicMutation(ref weight);
            else if (chance < .475f)
                LightPercentageMutation(ref weight);
    ...
    public class TrainerBase : UnityEngine.MonoBehaviour
    {
        ...
        void MutationStrategyChange()
        {
            NeuralNetwork.mutationType = mutationStrategy;
        }
        void SortTeam()
        {//InsertionSort
